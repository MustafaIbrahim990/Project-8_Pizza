...
*/
        ...
        private void rbSmall_CheckedChanged(object sender, EventArgs e)
        {
            if (rbSmall.Checked)
            {
                labPS.Text = rbSmall.Text;
                TotalPrice += 5;
                labTP.Text = "$" + Convert.ToString(TotalPrice);
            }
            else
            {
                TotalPrice -= 5;
        ...
        private void chbGreenPeppers_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                // labT.Text += chbGreenPeppers.Text + ",";
                TotalPrice += 5;
                labTP.Text = "$" + Convert.ToString(TotalPrice);
            }
            else
